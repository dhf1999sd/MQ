...
// Company:          TSN@NNS
// Engineer:         Wenxue Wu
// Create Date:     2025/07/04 17:16:55
...
module frame_eligbility_calculator #(
  ...
  wire [TIMESTAMP_WIDTH-1:0]            group_eligibility_time;
  wire [TIMESTAMP_WIDTH-1:0]            update_bucket_empty_time;
  wire [TIMESTAMP_WIDTH-1:0]            update_group_eligibility_time;
  wire [TIMESTAMP_WIDTH-1:0]            bucket_empty_time;
